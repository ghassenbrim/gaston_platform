        ...
        <main className="min-h-screen bg-stone-50 text-slate-950">
                    ...
                    <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
                        <div className="space-y-5">
                            <h1 className={`${playfair.className} max-w-3xl text-5xl italic leading-tight text-slate-950 sm:text-7xl`}>
                                Estimez votre séance en quelques choix
                            </h1>
                            <p className="max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
                                Sélectionnez le type de travail, une date et le pack souhaité pour obtenir une première estimation claire avant la réservation.
                            </p>
                        </div>
            ...
            <section className="mx-auto grid max-w-7xl gap-8 px-5 py-10 sm:px-8 lg:grid-cols-[minmax(0,1fr)_390px] lg:px-12">
                        ...
                        <div className="mt-8 rounded-[2rem] border border-dashed border-slate-300 bg-slate-50 p-5 sm:p-6">
                            ...
                            <div className="mt-5 rounded-2xl bg-white p-4 text-sm font-semibold text-slate-600">
                                {selectedPack ? (
                                    ...
                                    <p>
                                        Sélection personnalisée : le devis utilise la somme des services à la carte.
                                    </p>
                                )}
                            </div>
                        </div>
                ...
                <aside className="h-fit rounded-[2rem] border border-slate-900 bg-slate-950 p-6 text-white shadow-2xl shadow-slate-300 lg:sticky lg:top-8">
                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#bca086]">Votre estimation</p>
                    <h2 className={`${playfair.className} mt-4 text-5xl italic`}>{formatPrice(estimatedTotal)}</h2>
                    <p className="mt-4 text-sm leading-7 text-slate-300">
                        Montant indicatif calculé selon vos choix. Le devis final peut être ajusté après validation des détails du projet.
                    </p>
                    ...
                    <Link
                        href="/role/welcompage"
                        className="mt-6 flex w-full items-center justify-center rounded-full bg-[#bca086] px-6 py-4 text-center text-[11px] font-black uppercase tracking-[0.22em] text-white transition hover:bg-white hover:text-slate-950"
                    >
                        Continuer
                    </Link>
                </aside>
